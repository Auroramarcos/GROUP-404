/* script.js
  - Red asteroid-like falling objects
  - Improved explosions: shards + smoke + tiny sparks
  - Sound pool (uses uploaded audio file path)
  - Restart + best-score persistence via localStorage
